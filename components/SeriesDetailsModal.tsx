...
export function SeriesDetailsModal({ series, isOpen, onClose, onOpenAddBook }: SeriesDetailsModalProps) {
      ...
      {createPortal(
        isOpen ? (
          <div className="modal-overlay anim-fade-in" onClick={onClose}>
            ...
            >
              <div className="modal-box__handle"><div className="modal-box__handle-bar" /></div>
                    ...
                    {isEditingName ? (
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-1)' }}>
                        <h2 id="series-details-title" style={{
                          ...
                          lineHeight: 'var(--leading-snug)', flex: 1, minWidth: 0,
                        }}>{series.name}</h2>
                ...
                {!booksInSeries || booksInSeries.length === 0 ? (
                  ...
                  booksInSeries.map((book, idx) => (
                    ...
                    >
                      ...
                      <BookCover book={book} />
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <p style={{ fontFamily: 'var(--font-display)', fontSize: 'var(--text-sm)', fontStyle: 'italic', color: 'var(--color-text)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', lineHeight: 'var(--leading-snug)' }}>
                          {book.title}
                        </p>
