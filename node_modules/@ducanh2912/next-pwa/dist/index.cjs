...
var r$1 = y;let a = semver.coerce(getPackageVersion("next")), t = !!a && semver.lt(a, "13.4.1"), w = !!a && semver.lt(a, "13.4.20"), i$1 = {
    wait: "log",
    error: "error",
    warn: "warn",
    info: "log",
...
};let l = url.fileURLToPath(new URL(".", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('index.cjs', document.baseURI).href))));
...
};let i = url.fileURLToPath(new URL(".", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('index.cjs', document.baseURI).href))));
...
};let r = url.fileURLToPath(new URL(".", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('index.cjs', document.baseURI).href))));
const buildSWEntryWorker = (e)=>{
    ...
    return {
        ...
        }));exports.default=index;exports.runtimeCaching=e;